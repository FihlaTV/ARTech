...
+ (void)genNFTMarkerFile:(NSString *)markerPath markerName:(NSString *)markerName {
    NSString *markerInfo = @"1\n"; // Number of markers
    markerInfo = [markerInfo stringByAppendingFormat:@"%@\n", markerName]; //Name of pattern file (relative to this file)
    markerInfo = [markerInfo stringByAppendingString:@"\n"];
    markerInfo = [markerInfo stringByAppendingFormat:@"%@\n", @"NFT"]; //Marker type (SINGLE)
    markerInfo = [markerInfo stringByAppendingFormat:@"FILTER %f\n", 15.0]; //FILTER
    markerInfo = [markerInfo stringByAppendingString:@"\n"];
    [markerInfo writeToFile:markerPath atomically:YES encoding:NSUTF8StringEncoding error:nil];
}
...
+ (void)genNFTData:(NSString *)imagePath {
    ...
    NSString *markerFilePath = [savePathUrl.path stringByAppendingString:@".nftmarker"];
    NSString *markerName = [savePathUrl lastPathComponent];
    [self genNFTMarkerFile:markerFilePath markerName:markerName ];
}
